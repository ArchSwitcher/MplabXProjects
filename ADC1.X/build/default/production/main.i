...
void Lcd_Cmd(char a)
{
 ...
 Lcd_Port(a);
 PORTDbits.RD3 = 1;
        _delay((unsigned long)((4)*(16000000L/4000.0)));
        PORTDbits.RD3 = 0;
}
...
{
  Lcd_Port(0x00);
   _delay((unsigned long)((20)*(16000000L/4000.0)));
  Lcd_Cmd(0x03);
 _delay((unsigned long)((5)*(16000000L/4000.0)));
  Lcd_Cmd(0x03);
 _delay((unsigned long)((11)*(16000000L/4000.0)));
  Lcd_Cmd(0x03);
...
void Lcd_Write_Char(char a)
{
   ...
   Lcd_Port(y>>4);
   PORTDbits.RD3 = 1;
   _delay((unsigned long)((40)*(16000000L/4000000.0)));
   PORTDbits.RD3 = 0;
   Lcd_Port(temp);
   PORTDbits.RD3 = 1;
   _delay((unsigned long)((40)*(16000000L/4000000.0)));
...
void main(void) {
    ...
    _delay((unsigned long)((1000)*(16000000L/4000.0)));
    Lcd_Clear();

    while(1){
        Lcd_Set_Cursor(1,1);
        Lcd_Write_String("EL Valor ES");
        _delay((unsigned long)((500)*(16000000L/4000.0)));

        Value = ADC_Read(0);
        voltage = Value*5.0/1023;
        sprintf(datos,"%.3f",voltage);
