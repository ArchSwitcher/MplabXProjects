...
# 52 "/opt/microchip/xc8/v2.05/pic/include/pic18f4550.h"
...
if(data_in=='1')
{
USART_SendString("delay1");
delay=1;
}
else if(data_in=='2')

{
USART_SendString("delay2");
transform(Counter);
delay=2;
}
else if(data_in=='3')
{
USART_SendString("delay3");
delay=3;
}
else if(data_in=='4')
{
USART_SendString(" delay4");
delay=4;
}
else if(data_in=='5')
{
...
USART_SendString("select 1, 2 or 3 or 4");
}
